...
<body>
    <div class="kantong">
        <div class="container">
            <img src="logo1.png" alt="logo" width="100px" height="100px">
            <div class="navbar">
                <div class="navb1">
        ...
        <div class="container2">
            <div id="gifts">
                ...
                <a href="login.php">Go get your Gifts!</a>
            </div>
            <br>
            <br>
            <div id="commission">
                ...
                <a href="login.php">Let's do Commission!</a>
            </div>
            <br>
            <br>
            <div id="premium">
                ...
                <a href="login.php">Go to Premium Page</a>
            </div>
        </div>
        <br><br><br><br>
